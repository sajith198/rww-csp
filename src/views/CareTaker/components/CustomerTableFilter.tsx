...
const options: Option[] = [
    ...
    { value: 'monthly', label: 'Monthly', color: 'bg-emerald-500' },
    { value: 'quarterly', label: 'Quarterly', color: 'bg-red-500' },
    { value: 'halfYearly', label: 'Half Yearly', color: 'bg-emerald-500' },
    { value: 'yearly', label: 'Yearly', color: 'bg-red-500' },
    { value: 'fullPaid', label: 'Full Paid', color: 'bg-red-500' },
]
