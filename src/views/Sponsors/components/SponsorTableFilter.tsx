...
const options: Option[] = [
    ...
    { value: 'm', label: 'Monthly', color: 'bg-orange-500' },
    { value: 'q', label: 'Quarterly', color: 'bg-green-500' },
    { value: 'he', label: 'Half Yearly', color: 'bg-red-500' },
    { value: 'y', label: 'Yearly', color: 'bg-red-500' },
    { value: 'f', label: 'Full Paid', color: 'bg-red-500' },
]
...
export default SponsorTableFilter
