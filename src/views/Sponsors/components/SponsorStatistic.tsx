...
const StatisticCard = (props: StatisticCardProps) => {
    const { icon, avatarClass, label, value, growthRate, loading, showRate } =
        props
...
const CustomerStatistic = () => {
    ...
    const statisticData = useAppSelector(
        (state) => state.rwwSponsors.data.statisticData
    )
    const loading = useAppSelector(
        (state) => state.rwwSponsors.data.statisticLoading
    )
