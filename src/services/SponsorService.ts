import { SponsorInformationType } from '@/@types/common'
...
export async function apiGetSponsors<T, U extends Record<string, unknown>>(
    data: U
) {
    return ApiService.fetchData<T>({
        url: `/sponsors/fetchSponsorList/0/50`,
        method: 'get',
    })
}
